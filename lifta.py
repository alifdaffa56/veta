...
oepoll = OEPoll(cl)
call = cl
creator = ["ucc734d8e2b24eb497b90fd33b4b17939"]
owner = ["ucc734d8e2b24eb497b90fd33b4b17939"]
admin = ["ucc734d8e2b24eb497b90fd33b4b17939"]
staff = ["ucc734d8e2b24eb497b90fd33b4b17939"]
...
wait = {
    ...
    "sticker":False,  
    "selfbot":True,
    "mention":"cieeeeee yang stalking....sini masuk",
    "Respontag":"╭═════════════╮\n│╭━━━═════━━━╮\n┣►  CANNIBAL TEAM BOT PROTECT\n│╰━━━═━═━━━━━╯\n╰═════════════╯",
    "welcome":"Wellcome to my Fams",
    "comment":"Auto like By�CANNIBAL",
    "comment1":"Auto like By CANNIBAL",
    "message":"Ciee ketahuan nge add kepo ye..\nThanks for add me..\n\nCANNIBAL"
}
...
def help():
    ...
    key = key.title()
    helpMessage = "╭━━━━━━━━━━━━━━━\n"
    helpMessage += "┃ " + "[[CANNIBAL]]\n"
    helpMessage += "┃" + " MENU CANNIBAL\n"
    helpMessage += "┃" + " ├──────────────\n"
    helpMessage += "╠❂➣ %i. " % num + key + "Aku\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "Sp\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "Rempong @\n"
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "Mbut\n"
    num = (num+1)   
    ...
    num = (num+1)
    helpMessage += "╠❂➣ %i. " % num + key + "Colek on/off\n"
    num = (num+1)
    ...
    num = (num+1)    
    helpMessage += "┃ " + "├──────────────\n"
    helpMessage += "┃ " + "[[CANNIBAL TEAM BOT\n"
    helpMessage += "╰━━━━━━━━━━━━━━━━"
    helpMessage += " Creator: [[CANNIBAL]] \n"
    return helpMessage
...
def helpbot():
    ...
    key = key.title()
    helpMessage2 = "╭━━━━━━━━━━━━━━━━\n"
    helpMessage2 += "┃ " + "[[CANNIBAL TEAM BOT]]\n"
    helpMessage2 += "┃" + " MENU CANNIBAL\n"
    helpMessage2 += "┃" + " ├──────────────\n"
    helpMessage2 += "╠❂➣ %i. " % num + key + "Kicker @\n"
    num = (num+1)
    helpMessage2 += "╠❂➣ %i. " % num + key + "Vt @ \n"
    num = (num+1)
    ...
    num = (num+1)     
    helpMessage2 += "╠❂➣ %i. " % num + key + "Cannibal [kickall]\n"
    num = (num+1)
    helpMessage2 += "╠❂➣ %i. " % num + key + "Lifta [kickall]\n"
    num = (num+1)
    helpMessage2 += "╠❂➣ %i. " % num + key + "Rifta \n"
    num = (num+1)
...
def helpbot1():
    ...
    key = key.title()
    helpMessage3 = "╭━━━━━━━━━━━━━━━━\n"
    helpMessage3 += "┃ " + "[[CANNIBAL TEAM BOT]]\n"
    helpMessage3 += "┃" + " CANNIBAL MENU\n"
    helpMessage3 += "┃" + " ├──────────────\n"
...
def helpbot2():
    ...
    key = key.title()
    helpMessage4 = "╭━━━━━━━━━━━━━━━━\n"
    helpMessage4 += "┃ " + "[[CANNIBAL TEAM BOT]]\n"
                          ...
                          if wait["selfbot"] == True:
                    	    ...
                    	    if msg._from in owner or msg._from in admin or msg._from in staff: 
                              ...
                              cl.sendMessage(msg.to, None,contentMetadata={'mid': sender}, contentType=13)
                               ...
                               cl.sendMessage(msg.to, "Alhamdulillah untung aim bukan bot")
                          ...
                          if msg._from in admin:
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    zxc = ""
                                    zx2 = []
                                    xpesan = 'Sorry CANNIBAL mudik dullu\n\nsilahkan invite owner kami '
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠ " + str(a) + ". " +G.name+ "\n"
                               cl.sendMessage(msg.to,"╔══[ LIST GRUP CANNIBAL  ]\n║\n"+ma+"║\n╚══[ Total「"+str(len(gid))+"」Groups ]")
                            ...
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠ " + str(a) + ". " +G.name+ "\n"
                               ki.sendMessage(msg.to,"╔══[ LIST GRUP CANNIBAL ]\n║\n"+ma+"║\n╚══[ Total「"+str(len(gid))+"」Groups ]")
                            ...
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠ " + str(a) + ". " +G.name+ "\n"
                               kk.sendMessage(msg.to,"╔══[ LIST GRUP CANNIBAL ]\n║\n"+ma+"║\n╚══[ Total「"+str(len(gid))+"」Groups ]")
                            ...
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠ " + str(a) + ". " +G.name+ "\n"
                               kc.sendMessage(msg.to,"╔══[ LIST GRUP CANNIBAL  ]\n║\n"+ma+"║\n╚══[ Total「"+str(len(gid))+"」Groups ]")
                            ...
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠ " + str(a) + ". " +G.name+ "\n"
                               km.sendMessage(msg.to,"╔══[ LIST GRUP CANNIBAL ]\n║\n"+ma+"║\n╚══[ Total「"+str(len(gid))+"」Groups ]")
                            ...
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠ " + str(a) + ". " +G.name+ "\n"
                               kb.sendMessage(msg.to,"╔══[ LIST GRUP CANNIBAL ]\n║\n"+ma+"║\n╚══[ Total「"+str(len(gid))+"」Groups ]")
                            ...
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠ " + str(a) + ". " +G.name+ "\n"
                               sw.sendMessage(msg.to,"╔══[ LIST GRUP CANNIBAL ]\n║\n"+ma+"║\n╚══[ Total「"+str(len(gid))+"」Groups ]")
                            ...
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠ " + str(a) + ". " +G.name+ "\n"
                               dz.sendMessage(msg.to,"╔══[ LIST GRUP CANNIBAL ]\n║\n"+ma+"║\n╚══[ Total「"+str(len(gid))+"」Groups ]")
...
#===========BOT UPDATE============#                                                          
                        elif cmd == "jones" or text.lower() == 'tes':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
...
#====================================================================                            
                         ...
                         if msg._from in admin:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ki.sendMessage(msg.to, "[[CANNIBAL]]")
                               kk.sendMessage(msg.to, " [[CANNIBAL]]")
                               kc.sendMessage(msg.to, "[[CANNIBAL]]")
                               km.sendMessage(msg.to, "[[CANNIBAL]]")
                               kb.sendMessage(msg.to, "[[CANNIBAL]]")
                               sw.sendMessage(msg.to, "[[CANNIBAL]]")
                               dz.sendMessage(msg.to, "[[CANNIBAL]]")
...
#===========KICKOUT============#       
                          ...
                          if wait["selfbot"] == True:
                        ...
                        elif ("Rifta" in msg.text):
                            if msg._from in admin:
                             if msg.toType == 2:
                                 print ("[ 19 ] KICK ALL MEMBER")
                                 _name = msg.text.replace("Bubar","Rifta")                                 
                                 ...
                                 cl.sendMessage(msg.to,"haloooooo")
                                 cl.sendMessage(msg.to,"「 Sorry CANNIBAL UDAH DATANG")
                                 targets = []
                                 for g in gs.members:
                           ...
                           if msg._from in owner or msg._from in admin or msg._from in staff:
                           	if msg.toType == 2:
                                  ...
                                  _name = text.lower().replace('cannibal','')
                                  gs = ki.getGroup(msg.to)
                                  gs = kk.getGroup(msg.to)
                                  gs = kc.getGroup(msg.to)
                                  gs = km.getGroup(msg.to)
...
#===========COMMAND BLACKLIST============#
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in owner or msg._from in admin:
                               ...
                               cl.sendMessage(msg.to, "cie pake sc nya cannibal  ya")
#===========COMMAND SET============#
